...
/*********************************************************************************************************
   定义Uart器件数目
*********************************************************************************************************/
#define UART_MAX_NUM    4                                             /*  LPC23xx有4个UART            */
...
#define QUEUE2REVICEFIFOLEN      128                                    /*  用户可在此修改接收软FIFO大小*/ 
#define QUEUE2SENDFIFOLEN        128                                    /*  用户可在此修改发送软FIFO大小*/ 
#define QUEUE2REVICEFIFOLENFUN   QUEUE2REVICEFIFOLEN+28                 /*  用户不要修改                */
#define QUEUE2SENDFIFOLENFUN     QUEUE2SENDFIFOLEN+28                   /*  用户不要修改                */

#define QUEUE3REVICEFIFOLEN      256                                    /*  用户可在此修改接收软FIFO大小*/ 
#define QUEUE3SENDFIFOLEN        256                                    /*  用户可在此修改发送软FIFO大小*/ 
#define QUEUE3REVICEFIFOLENFUN   QUEUE3REVICEFIFOLEN+28                 /*  用户不要修改                */
#define QUEUE3SENDFIFOLENFUN     QUEUE3SENDFIFOLEN+28                   /*  用户不要修改                */
