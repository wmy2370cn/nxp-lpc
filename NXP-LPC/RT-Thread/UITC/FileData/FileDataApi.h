...
//擦除
INT8U  ErasureFlash( void ); 

INT8U LoadFlashData( );

//读操作，从flash中读取相应的配置
INT16U LoadFcb(FCB *pFcb,INT8U *err);
//由通信模块调用或者在系统启动时初始化调用
INT8U  ReadSrcDataBuf(INT8U *pBuff, INT32U nFileOffset,INT8U nLen);
INT8U  ReadBinDataBuf(INT8U *pBuff, INT32U nFileOffset,INT8U nLen);

INT8U  GetFcbBuff(INT8U **pBuff,INT8U *pLen );
INT8U  GetBinDataBuff(INT8U **ppBuff, INT32U *pLen);
INT8U  GetSrcDataBuff(INT8U **ppBuff, INT32U *pLen);
