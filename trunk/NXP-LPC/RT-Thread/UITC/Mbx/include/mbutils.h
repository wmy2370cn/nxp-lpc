 ...
 * MBUtilSetBits( ucBits, 4, 1, 1 );
 *
 * // Set bit 7 to 1 and bit 8 to 0.
 * MBUtilSetBits( ucBits, 7, 2, 0x01 );
 *
 * // Set bits 8 - 11 to 0x05 and bits 12 - 15 to 0x0A;
 * MBUtilSetBits( ucBits, 8, 8, 0x5A);
 * \endcode
 */
void            MBUtilSetBits( UCHAR * ucByteBuf, USHORT usBitOffset,
 ...
 * ucResult = MBUtilGetBits( ucBits, 3, 8 );
 * \endcode
 */
UCHAR           MBUtilGetBits( UCHAR * ucByteBuf, USHORT usBitOffset,
                                UCHAR ucNBits );
