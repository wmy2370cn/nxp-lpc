...
#define FIO00DIR       (*(volatile unsigned char *)(FIO_BASE_ADDR + 0x00)) 
#define FIO10DIR       (*(volatile unsigned char *)(FIO_BASE_ADDR + 0x20)) 
#define FIO20DIR       (*(volatile unsigned char *)(FIO_BASE_ADDR + 0x40)) 
#define FIO30DIR       (*(volatile unsigned char *)(FIO_BASE_ADDR + 0x60)) 
#define FIO40DIR       (*(volatile unsigned char *)(FIO_BASE_ADDR + 0x80)) 
...
#define FIO01DIR       (*(volatile unsigned char *)(FIO_BASE_ADDR + 0x01)) 
#define FIO11DIR       (*(volatile unsigned char *)(FIO_BASE_ADDR + 0x21)) 
#define FIO21DIR       (*(volatile unsigned char *)(FIO_BASE_ADDR + 0x41)) 
#define FIO31DIR       (*(volatile unsigned char *)(FIO_BASE_ADDR + 0x61)) 
#define FIO41DIR       (*(volatile unsigned char *)(FIO_BASE_ADDR + 0x81)) 
...
#define FIO02DIR       (*(volatile unsigned char *)(FIO_BASE_ADDR + 0x02)) 
#define FIO12DIR       (*(volatile unsigned char *)(FIO_BASE_ADDR + 0x22)) 
#define FIO22DIR       (*(volatile unsigned char *)(FIO_BASE_ADDR + 0x42)) 
#define FIO32DIR       (*(volatile unsigned char *)(FIO_BASE_ADDR + 0x62)) 
#define FIO42DIR       (*(volatile unsigned char *)(FIO_BASE_ADDR + 0x82)) 
...
#define FIO03DIR       (*(volatile unsigned char *)(FIO_BASE_ADDR + 0x03)) 
#define FIO13DIR       (*(volatile unsigned char *)(FIO_BASE_ADDR + 0x23)) 
#define FIO23DIR       (*(volatile unsigned char *)(FIO_BASE_ADDR + 0x43)) 
#define FIO33DIR       (*(volatile unsigned char *)(FIO_BASE_ADDR + 0x63)) 
#define FIO43DIR       (*(volatile unsigned char *)(FIO_BASE_ADDR + 0x83)) 
...
/***************************************************************************
 **
 **  Register Aliases (for Inter-Toolchain Compatibility)
 ** 
 ***************************************************************************/

#define IO0INTENR               IO0_INT_EN_R
#define IO0INTENF               IO0_INT_EN_F
#define IO0INTSTATR             IO0_INT_STAT_R
#define IO0INTSTATF             IO0_INT_STAT_F
#define IO0INTCLR               IO0_INT_CLR
#define IO1INTENR               IO2_INT_EN_R
#define IO1INTENF               IO2_INT_EN_F
#define IO1INTSTATR             IO2_INT_STAT_R
#define IO1INTSTATF             IO2_INT_STAT_F
#define IO1INTCLR               IO2_INT_CLR
#define IOINTSTATUS             IO_INT_STAT
...
#define EMCCONTROL		        EMC_CTRL
#define EMCSTATUS		        EMC_STAT
#define EMCCONFIG		        EMC_CONFIG
#define EMCDINAMICCTRL		    EMC_DYN_CTRL
#define EMCDINAMICRFR		    EMC_DYN_RFSH
#define EMCDINAMICRDCFG		    EMC_DYN_RD_CFG
#define EMCDYNAMICRP		    EMC_DYN_RP
#define EMCDYNAMICRAS		    EMC_DYN_RAS
#define EMCDYNAMICSREX		    EMC_DYN_SREX
#define EMCDYNAMICAPR		    EMC_DYN_APR
#define EMCDYNAMICDAL		    EMC_DYN_DAL
#define EMCDYNAMICWR		    EMC_DYN_WR
#define EMCDYNAMICRC		    EMC_DYN_RC
#define EMCDYNAMICRFC		    EMC_DYN_RFC
#define EMCDYNAMICXSR		    EMC_DYN_XSR
#define EMCDYNAMICRRD		    EMC_DYN_RRD
#define EMCDYNAMICMRD		    EMC_DYN_MRD
#define EMCDYNAMICCFG0		    EMC_DYN_CFG0
#define EMCDYNAMICRASCAS0	    EMC_DYN_RASCAS0
#define EMCDYNAMICCFG1		    EMC_DYN_CFG1
#define EMCDYNAMICRASCAS1	    EMC_DYN_RASCAS1
#define EMCDYNAMICCFG2		    EMC_DYN_CFG2
#define EMCDYNAMICRASCAS2	    EMC_DYN_RASCAS2
#define EMCDYNAMICCFG3		    EMC_DYN_CFG3
#define EMCDYNAMICRASCAS3	    EMC_DYN_RASCAS3
#define EMCSTATICCNFG0		    EMC_STA_CFG0
#define EMCSTATICWAITWEN0	    EMC_STA_WAITWEN0
#define EMCSTATICWAITOEN0	    EMC_STA_WAITOEN0
#define EMCSTATICWAITRD0	    EMC_STA_WAITRD0
#define EMCSTATICWAITPG0	    EMC_STA_WAITPAGE0
#define EMCSTATICWAITWR0	    EMC_STA_WAITWR0
#define EMCSTATICWAITTURN0	    EMC_STA_WAITTURN0
#define EMCSTATICCNFG1		    EMC_STA_CFG1
#define EMCSTATICWAITWEN1	    EMC_STA_WAITWEN1
#define EMCSTATICWAITOEN1	    EMC_STA_WAITOEN1
#define EMCSTATICWAITRD1	    EMC_STA_WAITRD1
#define EMCSTATICWAITPG1	    EMC_STA_WAITPAGE1
#define EMCSTATICWAITWR1	    EMC_STA_WAITWR1
#define EMCSTATICWAITTURN1	    EMC_STA_WAITTURN1
#define EMCSTATICCNFG2		    EMC_STA_CFG2
#define EMCSTATICWAITWEN2	    EMC_STA_WAITWEN2
#define EMCSTATICWAITOEN2	    EMC_STA_WAITOEN2
#define EMCSTATICWAITRD2	    EMC_STA_WAITRD2
#define EMCSTATICWAITPG2	    EMC_STA_WAITPAGE2
#define EMCSTATICWAITWR2	    EMC_STA_WAITWR2
#define EMCSTATICWAITTURN2	    EMC_STA_WAITTURN2
#define EMCSTATICCNFG3		    EMC_STA_CFG3
#define EMCSTATICWAITWEN3	    EMC_STA_WAITWEN3
#define EMCSTATICWAITOEN3	    EMC_STA_WAITOEN3
#define EMCSTATICWAITRD3	    EMC_STA_WAITRD3
#define EMCSTATICWAITPG3	    EMC_STA_WAITPAGE3
#define EMCSTATICWAITWR3	    EMC_STA_WAITWR3
#define EMCSTATICWAITTURN3	    EMC_STA_WAITTURN3
#define EMCSTATICEXTENDEDWAIT	EMC_STA_EXT_WAIT
